...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.example.tasks.model.tasks.Person} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PersonItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addIsInvolvedInTasksPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TasksPackage.Literals.PERSON__FIRST_NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TasksPackage.Literals.PERSON__LAST_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Is Involved In Tasks feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsInvolvedInTasksPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_isInvolvedInTasks_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_isInvolvedInTasks_feature", "_UI_Person_type"),
				 TasksPackage.Literals.PERSON__IS_INVOLVED_IN_TASKS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addLeadsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Person_leads_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Person_leads_feature", "_UI_Person_type"),
				 TasksPackage.Literals.PERSON__LEADS,
				 true,
				 false,
				 true,
				 null,
