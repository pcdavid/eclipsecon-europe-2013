...
/**
 * This is the item provider adapter for a {@link org.eclipse.sirius.example.tasks.model.tasks.AbstractNamedElement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AbstractNamedElementItemProvider
	 ...
	 * @generated
	 */
	public AbstractNamedElementItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((AbstractNamedElement)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_AbstractNamedElement_type") :
			getString("_UI_AbstractNamedElement_type") + " " + label;
	}
