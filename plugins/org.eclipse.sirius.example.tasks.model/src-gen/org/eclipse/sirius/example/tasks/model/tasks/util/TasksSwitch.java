...
public class TasksSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TasksPackage.TASK: {
				...
				if (result == null) result = caseAbstractPlanableElement(task);
				if (result == null) result = caseAbstractNamedElement(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TasksPackage.PROJECT_VERSION: {
				ProjectVersion projectVersion = (ProjectVersion)theEObject;
				T result = caseProjectVersion(projectVersion);
				if (result == null) result = caseAbstractPlanableElement(projectVersion);
				if (result == null) result = caseAbstractNamedElement(projectVersion);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TasksPackage.ABSTRACT_NAMED_ELEMENT: {
			...
			case TasksPackage.ABSTRACT_PLANABLE_ELEMENT: {
				AbstractPlanableElement abstractPlanableElement = (AbstractPlanableElement)theEObject;
				T result = caseAbstractPlanableElement(abstractPlanableElement);
				if (result == null) result = caseAbstractNamedElement(abstractPlanableElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TasksPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TasksPackage.PROJECT: {
			...
			case TasksPackage.TASK_REPOSITORY: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Abstract Planable Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Abstract Planable Element</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAbstractPlanableElement(AbstractPlanableElement object) {
		return null;
	}
