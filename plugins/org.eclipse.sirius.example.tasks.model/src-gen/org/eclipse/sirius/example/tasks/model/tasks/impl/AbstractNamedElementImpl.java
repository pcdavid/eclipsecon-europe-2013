 ...
 * <ul>
 *   <li>{@link org.eclipse.sirius.example.tasks.model.tasks.impl.AbstractNamedElementImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class AbstractNamedElementImpl extends EObjectImpl implements AbstractNamedElement {
	...
	protected EClass eStaticClass() {
		return TasksPackage.Literals.ABSTRACT_NAMED_ELEMENT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TasksPackage.ABSTRACT_NAMED_ELEMENT__NAME, oldName, name));
	}
